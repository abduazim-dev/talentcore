            ...
            <div className="p-6 md:p-14 border rounded-2xl border-[#6366F14D] bg-custom-gradient relative overflow-hidden">
                            ...
                            {timeUnits.map((item, index) => (
                                <div key={item.label} className="flex gap-2 items-center">
                                    <div className="flex flex-col items-center">
                                        <span className="text-2xl md:text-3xl bg-[#FFFFFF0F] py-2 px-3 rounded-lg border border-[#FFFFFF1A] font-bold font-mono tabular-nums">
                                            {String(timeLeft[item.value]).padStart(2, "0")}
                                        </span>
                                        <span className="text-[#4A5568] text-[10px] mt-1 uppercase tracking-wider">
                                            {item.label}
                                        </span>
                                    </div>
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 mt-12">
                    {bonuses.map((bonus, index) => (
                        ...
                        >
                            ...
                            <h2 className="text-xl mt-4 font-bold group-hover:text-[#F59E0B] transition-colors duration-300">
                                {bonus.title}
                            </h2>
                ...
                >
                    <button className="group relative bg-linear-to-r from-[#F59E0B] to-[#EF4444]
                        ...
                        px-10 py-4 font-bold rounded-xl text-white
                        transition-all duration-300 hover:-translate-y-1 active:translate-y-0 active:scale-95 whitespace-nowrap">
