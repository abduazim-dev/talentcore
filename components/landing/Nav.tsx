    ...
    return (
        <nav className="px-24 py-4 flex justify-between items-center">
            ...
            <div className="flex gap-8">
                {navlinks.map((link) => (
                    <a className="text-[#7A8A9E] hover:text-white transition-colors duration-200" href="#" key={link}>{link}</a>
                ))}
            </div>
            <div className="flex gap-3 items-center">
                <a className="hover:text-[#7A8A9E] transition-colors duration-200" href="#">Kirish</a>
